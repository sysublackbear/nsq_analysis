...
// lookup是通过http请求的操作。消费者对特定的topic和channel感兴趣，因此消费者向nsqlookupd发起lookup操作，
// 找到Channel对应的生产者Producers, 然后与这些Producers建立连接，订阅相关信息。

// lookup操作是根据Topic查询该topic底下的所有channel，和对应的producers。
